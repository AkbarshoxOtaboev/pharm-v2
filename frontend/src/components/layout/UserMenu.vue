...
<template>
  <div ref="root" class="relative">
    <button
      type="button"
      class="flex items-center gap-2 rounded-full py-1 pr-1 pl-1 hover:bg-gray-50 sm:pr-2"
      @click="open = !open"
    >
      <UserAvatar :avatar="auth.avatar" :name="auth.fullName" size="sm" />
      <span class="hidden text-theme-sm font-medium text-gray-700 sm:inline">
    ...
    <div
      v-if="open"
      class="absolute right-0 z-50 mt-3 w-[260px] overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-theme-lg"
    >
      ...
      <div class="p-2">
        <button
          type="button"
          class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-theme-sm text-gray-700 hover:bg-gray-50"
          @click="goProfile"
        >
      ...
      <div class="border-t border-gray-100 p-2">
        <button
          type="button"
          class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left text-theme-sm text-error-600 hover:bg-error-50"
          @click="onLogout"
        >
